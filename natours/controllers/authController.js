...
const createSendToken = (user, statusCode, res) => {
    ...
    const cookieOptions = {
        ...
        // secure: true, // allow transfer of cookie only through https
        httpOnly: true // prevent browser from changing the cookie in any way
    }
...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (!currentUser) {
        return next(new AppError('The user belonging to this toke no longer exists', 401));
    }
